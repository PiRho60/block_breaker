...
class Ball(pygame.sprite.Sprite):
    ...
    def check_platform_collision(self):
        if (pygame.sprite.collide_rect(self, self.platform)):
            ...
            # to the ball's angle, in correcponding range (pi, 0)
            angle = pi * (1 - (ball_platform_center_displacement + self.settings.PLATFORM_WIDTH/2) / self.settings.PLATFORM_WIDTH)
